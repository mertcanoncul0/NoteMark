...
import welcomeReadFile from '../../../resources/Welcome.md?asset'
...
export const getNotes: GetNotes = async () => {
  ...
  if (isEmpty(notes)) {
    ...
    const content = await readFile(welcomeReadFile, { encoding: fileEncoding })
...
export const deleteNote: DeleteNote = async (filename) => {
  ...
  const { response } = await dialog.showMessageBox({
    type: 'warning',
    title: 'Delete note',
    message: `Are you sure you want to delete ${fileEncoding}?`,
